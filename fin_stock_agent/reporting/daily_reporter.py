...
from fin_stock_agent.reporting.market_opportunity_agent import MarketOpportunityAgent
...
class DailyReporter:
    ...
    def generate(self, user_id: str, date: str | None = None, force: bool = False) -> DailyReport:
        ...
        if not force:
            ...
            if existing is not None:
                write_stats_event(
                    ...
                    market_idea_count=len(existing.market_fund_ideas),
        ...
        try:
            ...
            market_ideas = self.market_opportunity_agent.run(daily_briefing, limit=5).get("ideas", [])
            ...
            news_usage = {
                ...
                "market_opportunity": dict(self.market_opportunity_agent.last_usage),
            }
            ...
            report = self.synthesis_agent.run(
                ...
                news_ctx=news_ctx,
                fund_ctx=fund_ctx,
                market_fund_ideas=market_ideas,
            ...
            report_usage = {
                ...
                "market_opportunity": news_usage["market_opportunity"],
            ...
            write_stats_event(
                ...
                market_idea_count=len(report.market_fund_ideas),
